...
module sccomp_tb();
  ...
  initial begin
    ...
    if (sccomp.U_DM.dmem[96] !== 32'h2024_3021) begin
      $display("[FAIL] mem[0x180] expected original sid 0x20243021, got %h", sccomp.U_DM.dmem[96]);
      errors = errors + 1;
    end
    if (sccomp.U_DM.dmem[97] !== 32'h0012_2234) begin
      $display("[FAIL] mem[0x184] expected sorted sid 0x00122234, got %h", sccomp.U_DM.dmem[97]);
      errors = errors + 1;
    end
